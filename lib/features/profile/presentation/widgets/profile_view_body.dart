    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          HeaderProfile(),
          64.hs,
          ProfileItem(title: 'Password Management', icon: AppAssets.svgsIcPass),
          24.hs,
          ProfileItem(title: 'Payment Methods', icon: AppAssets.svgsIcPayment),
          24.hs,
          ProfileItem(title: 'Favourites', icon: AppAssets.svgsIcFav),
          24.hs,
          ProfileItem(title: 'FAQs', icon: AppAssets.svgsIcFaq),
          24.hs,
