...
class EphermeralKeysModel {
  ...
  factory EphermeralKeysModel.fromJson(Map<String, dynamic> json) {
    return EphermeralKeysModel(
  ...
  EphermeralKeysEntity toEntity() =>
      EphermeralKeysEntity(ephemeralKey: secret ?? '');
}
