...
class PaymentIntentsModel {
  ...
  factory PaymentIntentsModel.fromJson(Map<String, dynamic> json) {
    return PaymentIntentsModel(
  ...
  PaymentIntentsEntity toEntity() =>
      PaymentIntentsEntity(clientSecret: clientSecret ?? '');
}
